...
public class bl_Lobby : bl_PhotonHelper, IConnectionCallbacks, ILobbyCallbacks, IMatchmakingCallbacks
{
    ...
    public void CreateRoom(MFPSRoomInfo roomInfo)
    {
        ...
        roomOption[PropertiesKeys.GameModeKey] = GameMode.FFA.ToString ();//roomInfo.gameMode.ToString();
        roomOption[PropertiesKeys.SceneNameKey] = roomInfo.sceneName;
        roomOption[PropertiesKeys.RoomRoundKey] = RoundStyle.Rounds;//roomInfo.roundStyle;
        roomOption[PropertiesKeys.TeamSelectionKey] = true; // roomInfo.autoTeamSelection;
        roomOption[PropertiesKeys.CustomSceneName] = roomInfo.mapName;
        roomOption[PropertiesKeys.RoomGoal] = roomInfo.goal;
        roomOption[PropertiesKeys.RoomFriendlyFire] = false;// roomInfo.friendlyFire;
        roomOption[PropertiesKeys.MaxPing] = roomInfo.maxPing;
        roomOption[PropertiesKeys.RoomPassword] = roomInfo.password;
        roomOption[PropertiesKeys.WithBotsKey] = true;//roomInfo.withBots;
        ...
        {
            MaxPlayers =8,// (byte)roomInfo.maxPlayers,
            IsVisible = true,
            IsOpen = true,
